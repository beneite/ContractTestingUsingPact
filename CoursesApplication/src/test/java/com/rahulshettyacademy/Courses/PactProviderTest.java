...
public class PactProviderTest {
	...
	
	{
		...
		//to delete the appium record in database
		    ...
		    Optional<AllCourseDataEntity> del =repository.findById(name);//mock
		...
		String name =  (String)params.get("name");
		 Optional<AllCourseDataEntity> del =repository.findById(name);//mock
		    ...
		    if (!del.isPresent()) {
		    	...
		    	AllCourseDataEntity allCourseDataEntity = new AllCourseDataEntity();
		    	allCourseDataEntity.setCourse_name("Appium");
		    	allCourseDataEntity.setCategory("mobile");
		    	allCourseDataEntity.setPrice(120);
		    	allCourseDataEntity.setId("12");
		    	repository.save(allCourseDataEntity);
